        ...
        builder: (context, provider, _) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final taskGroupWithCount = provider.taskGroupsWithCounts[index]; ////AQUI
              
              return Dismissible(
                        key: Key(taskGroupWithCount.taskGroup.id),
                        background: const DeleteTaskGroup(),
                        onDismissed: (direction) async{
                         provider.taskGroupsWithCounts.removeAt(index);
                          await provider.deleteTaskGroup(taskGroupWithCount.taskGroup.id);
                        },
